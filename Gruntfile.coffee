...
module.exports = (grunt) ->
  grunt.initConfig
    ...
    concat:
      ...
      vendor:
        src: ["vendor/scripts/jquery-1.8.3.js", "vendor/scripts/underscore-1.4.3.js", "vendor/scripts/backbone-0.9.9.js", "vendor/scripts/handlebars.js", "vendor/scripts/handlebars-helpers.js", "vendor/scripts/console-helper.js", "vendor/scripts/jquery.serializeToJSON.js"]
    ...
    stylus:
      compile:
        files:
          "public/css/index.css": ["app/views/styles/bootstrap.styl", "app/views/styles/application.styl", "app/views/styles/header.styl", "app/views/styles/footer.styl", "app/views/styles/home-page.styl", "app/views/styles/login-page.styl"]
