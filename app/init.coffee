window.App =
  ...
  "Router": {}
  "utils": {}
  "bands": {"grateful-dead":{"name":"Grateful Dead","the":true},"marco":{"name":"Marco Benevento","the":false},"garage-a-trois":{"name":"Garage A Trois","the":false},"g-nome":{"name":"G-Nome Project","the":false},"furthur":{"name":"Furthur","the":false},"everyone-orchestra":{"name":"Everyone Orchestra","the":false},"dispatch":{"name":"Dispatch","the":false},"disco-biscuits":{"name":"Disco Biscuits","the":true},"dark-star":{"name":"Dark Star Orchestra","the":false},"weir":{"name":"Bob Weir","the":false},"bernie-worrell":{"name":"Bernie Worrell Orchestra","the":false},"duo":{"name":"Benevento Russo Duo","the":true},"ben-kweller":{"name":"Ben Kweller","the":false},"bela-fleck":{"name":"Bela Fleck and the Flecktones","the":true},"aqueous":{"name":"Aqueous","the":false},"aru":{"name":"Aquarium Rescue Unit","the":false},"animal-collective":{"name":"Animal Collective","the":false},"umphreys":{"name":"Umphrey's McGee","the":false},"max-creek":{"name":"Max Creek","the":false},"matisyahu":{"name":"Matisyahu","the":false},"lotus":{"name":"Lotus","the":false},"john-popper":{"name":"John Popper","the":false},"guster":{"name":"Guster","the":false},"greensky-bluegrass":{"name":"Greensky Bluegrass","the":false},"god-street-wine":{"name":"God Street Wine","the":false},"g-love":{"name":"G. Love and Special Sauce","the":false},"funky-butter":{"name":"Funky Butter","the":false},"fugazi":{"name":"Fugazi","the":false},"railroad-earth":{"name":"Railroad Earth","the":false},"yonder":{"name":"Yonder Mountain String Band","the":false},"ween":{"name":"Ween","the":false},"the-new-deal":{"name":"The New Deal","the":false},"the-heavy-pets":{"name":"The Heavy Pets","the":false},"sci":{"name":"String Cheese Incident","the":true},"steve-kimock":{"name":"Steve Kimock Band","the":true},"kimock":{"name":"Steve Kimock","the":false},"spoon":{"name":"Spoon","the":false},"raq":{"name":"Raq","the":false},"zero":{"name":"Zero","the":false},"kvhw":{"name":"KVHW","the":false},"stringdusters":{"name":"Infamous Stringdusters","the":true},"grace-potter":{"name":"Grace Potter","the":true}}
