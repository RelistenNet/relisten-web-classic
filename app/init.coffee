window.App =
  ...
  "Router": {}
  "utils": {}
  "bands": {"animal-collective":{"name":"Animal Collective"},"aqueous":{"name":"Aqueous"},"aru":{"name":"Aquarium Rescue Unit"},"bela-fleck":{"name":"Béla Fleck and the Flecktones"},"ben-kweller":{"name":"Ben Kweller"},"duo":{"name":"Benevento Russo Duo","the":true},"bernie-worrell":{"name":"Bernie Worrell Orchestra","the":true},"the-big-wu":{"name":"The Big Wu"},"blues-traveler":{"name":"Blues Traveler"},"the-breakfast":{"name":"The Breakfast"},"weir":{"name":"Bob Weir"},"club-d-elf":{"name":"Club d'Elf"},"dark-star":{"name":"Dark Star Orchestra"},"the-decemberists":{"name":"The Decemberists"},"disco-biscuits":{"name":"Disco Biscuits","the":true},"dispatch":{"name":"Dispatch"},"dopapod":{"name":"Dopapod"},"drive-by-truckers":{"name":"Drive-By Truckers","the":true},"elliott-smith":{"name":"Elliott Smith"},"everyone-orchestra":{"name":"Everyone Orchestra"},"fugazi":{"name":"Fugazi"},"furthur":{"name":"Furthur"},"g-love":{"name":"G. Love and Special Sauce"},"g-nome":{"name":"G-Nome Project","the":true},"garage-a-trois":{"name":"Garage A Trois"},"god-street-wine":{"name":"God Street Wine"},"grace-potter":{"name":"Grace Potter","the":true},"grateful-dead":{"name":"Grateful Dead","the":true},"greensky-bluegrass":{"name":"Greensky Bluegrass"},"guster":{"name":"Guster"},"the-heavy-pets":{"name":"The Heavy Pets"},"jack-johnson":{"name":"Jack Johnson"},"jazz-mandolin-project":{"name":"Jazz Mandolin Project","the":true},"jerry-joseph":{"name": "Jerry Joseph and the Jackmormons"},"john-popper":{"name":"John Popper"},"keller-williams":{"name":"Keller Williams"},"kvhw":{"name":"KVHW"},"leftover-salmon":{"name":"Leftover Salmon"},"little-feat":{"name":"Little Feat"},"lotus":{"name":"Lotus"},"marco":{"name":"Marco Benevento"},"matisyahu":{"name":"Matisyahu"},"matt-pond-pa":{"name":"Matt Pond PA"},"max-creek":{"name":"Max Creek"},"mmj":{"name":"My Morning Jacket"},"moe":{"name":"moe."},"mogwai":{"name":"Mogwai"},"the-motet":{"name":"The Motet"},"the-new-deal":{"name":"The New Deal"},"new-mastersounds":{"name":"The New Mastersounds"},"percy-hill":{"name":"Percy Hill"},"phil-lesh":{"name":"Phil Lesh and Friends"},"radiators":{"name":"The Radiators"},"railroad-earth":{"name":"Railroad Earth"},"raq":{"name":"Raq"},"ratdog":{"name":"Ratdog"},"ryan-adams":{"name":"Ryan Adams"},"sci":{"name":"String Cheese Incident","the":true},"smashing-pumpkins":{"name":"Smashing Pumpkins","the":true},"spoon":{"name":"Spoon"},"steve-kimock":{"name":"Steve Kimock"},"steve-kimock-band":{"name":"Steve Kimock Band","the":true},"strangefolk":{"name":"Strangefolk"},"stringdusters":{"name":"Infamous Stringdusters","the":true},"tea-leaf-green":{"name":"Tea Leaf Green"},"ted-leo":{"name":"Ted Leo and the Pharmacists"},"tedeschi-trucks":{"name":"Tedeschi Trucks Band","the":true},"tenacious-d":{"name":"Tenacious D"},"umphreys":{"name":"Umphrey's McGee"},"the-walkmen":{"name":"The Walkmen"},"war-on-drugs":{"name":"The War on Drugs"},"warren-zevon":{"name":"Warren Zevon"},"ween":{"name":"Ween"},"yonder":{"name":"Yonder Mountain String Band"},"zero":{"name":"Zero"}}
